...
namespace Tesseract
{
    public sealed class ResultIterator : PageIterator
    {
        ...
        public bool GetWordIsFromDictionary()
        {
            ...
            return Interop.TessApi.ResultIteratorWordIsFromDictionary(handle);
        }
        ...
        public bool GetWordIsNumeric()
        {
            ...
            return Interop.TessApi.ResultIteratorWordIsNumeric(handle);
        }
        ...
        public bool GetSymbolIsSuperscript()
        {
            ...
            return Interop.TessApi.ResultIteratorSymbolIsSuperscript(handle);
        }
        ...
        public bool GetSymbolIsSubscript()
        {
            ...
            return Interop.TessApi.ResultIteratorSymbolIsSubscript(handle);
        }
        ...
        public bool GetSymbolIsDropcap()
        {
            ...
            return Interop.TessApi.ResultIteratorSymbolIsDropcap(handle);
        }
