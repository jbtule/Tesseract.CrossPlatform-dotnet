<!-- Upstream charlesw/tesseract's original README content, preserved verbatim for reference (moved out of ReadMe.md, which now covers just this fork). See ReadMe.md for this fork's own README. -->
